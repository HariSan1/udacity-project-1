...
user_table_create = ("""CREATE TABLE IF NOT EXISTS users (user_id int PRIMARY KEY, f_name text, l_name text, gender text, level text) \
""")
...
artist_table_create = ("""CREATE TABLE IF NOT EXISTS artists (artist_id text PRIMARY KEY, artist_name text, location text, latitude float, longitude float) \
""")
