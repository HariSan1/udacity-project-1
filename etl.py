...
#process song and artist tables - open files, create dataframes, then convert to list
#then call insert queries from sql_queries.py
...
#process log files - time, user, songplay tables
def process_log_file(cur, filepath):
    ...
    # load user table
    #create datafram with user data
...
#process all the files in the data folders, iterate through each file from first to last
...
#put all the work above into a main function that processes and then closes connection
def main():
